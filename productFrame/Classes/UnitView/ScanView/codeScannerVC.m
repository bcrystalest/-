...
#import "codeScannerVC.h"
#import <AVFoundation/AVFoundation.h>

@interface codeScannerVC ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation codeScannerVC

- (id)init {
    self = [super init];
    if (self) {
        self.scanType = codeScannerTypeAll;
    }
    return self;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString *codeStr = @"";
    switch (_scanType) {
        case codeScannerTypeAll: codeStr = @"二维码/条码"; break;
        case codeScannerTypeQRCode: codeStr = @"二维码"; break;
        case codeScannerTypeBarcode: codeStr = @"条码"; break;
        default: break;
    }
...
- (void)loadScanView {
    ...
    switch (self.scanType) {
        ...
        case codeScannerTypeQRCode:
            output.metadataObjectTypes=@[AVMetadataObjectTypeQRCode];
            break;
            
        case codeScannerTypeBarcode:
